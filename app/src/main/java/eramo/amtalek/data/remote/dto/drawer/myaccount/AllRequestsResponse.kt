...
data class AllRequestsDto(
    ...
    fun toRequestModel(): RequestModel {
        return RequestModel(
            ...
            numAcs = numAcs ?: "",
            requestDate =
            if (LocalUtil.isEnglish()) requestDate ?: "" else requestDateAr ?: "",
            ...
            installationName =
            if (LocalUtil.isEnglish()) installationEnName ?: "" else installationArName ?: "",
            requestTypeName =
            if (LocalUtil.isEnglish()) requestTypeEnName ?: "" else requestTypeArName ?: ""
        )
    }
}