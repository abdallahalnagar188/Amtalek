...
import eramo.amtalek.data.remote.dto.products.common.ProductExtrasDto
import eramo.amtalek.data.remote.dto.products.common.ProductFeaturesDto
...
data class AllProductsDto(
    ...
    @SerializedName("slug_title_en") var slugTitleEn: String? = null,
    @SerializedName("slug_title_ar") var slugTitleAr: String? = null,
    ...
    @SerializedName("all_images") var allImages: List<AllImagesDto>? = null,
    ...
    @SerializedName("extra_products") var extraProducts: ArrayList<AllProductsDto> = arrayListOf(),
) {
    fun toProductModel(): ProductModel {
        if (LocalUtil.isEnglish()) productNameEn ?: "" else productNameAr ?: ""
        return ProductModel(
            productId = productId ?: "",
            productName = if (LocalUtil.isEnglish()) productNameEn ?: "" else productNameAr
                ?: "",
            slugTitle = if (LocalUtil.isEnglish()) slugTitleEn ?: "" else slugTitleAr ?: "",
            mainCatId = mainCatId ?: "",
            subCatId = subCatId ?: "",
            ...
            description = if (LocalUtil.isEnglish()) descrioptionEn ?: "" else descrioptionAr
                ?: "",
            comments = if (LocalUtil.isEnglish()) commentsEn ?: "" else commentsAr ?: "",
            updatedAt = updatedAt ?: "",
            status = getStatus(),
            featured = featured ?: "",
            hotCold = hotCold ?: "",
            hotColdName = if (LocalUtil.isEnglish()) hotColdEnName ?: "" else hotColdArName
                ?: "",
            inStockValue = inStock ?: "",
            inStockText = getStockText(),
            availableAmount = availableAmount ?: "",
            userId = userId ?: "",
            shipping = if (LocalUtil.isEnglish()) shippingEn ?: "" else shippingAr ?: "",
            features = if (LocalUtil.isEnglish()) featuresEn ?: "" else featuresAr ?: "",
            extras = if (LocalUtil.isEnglish()) extrasEn ?: "" else extrasAr ?: "",
            instructionsUse = if (LocalUtil.isEnglish()) instructionsUseEn
                ?: "" else instructionsUseAr ?: "",
            modelNumber = modelRkm ?: "",
            sku = skuRkm ?: "",
            mainCat = if (LocalUtil.isEnglish()) mainCatEn ?: "" else mainCatAr ?: "",
            subCat = if (LocalUtil.isEnglish()) subCatEn ?: "" else subCatAr ?: "",
            mainActypeName = if (LocalUtil.isEnglish()) mainActypeEnName
                ?: "" else mainActypeArName ?: "",
            subActypeName = if (LocalUtil.isEnglish()) subActypeEnName
                ?: "" else subActypeArName ?: "",
            manufacturerName = if (LocalUtil.isEnglish()) manufacturerEnName
                ?: "" else manufacturerArName ?: "",
            modelName = if (LocalUtil.isEnglish()) modelEnName ?: "" else modelArName ?: "",
            powerName = if (LocalUtil.isEnglish()) powerEnName ?: "" else powerArName ?: "",
            installationName = if (LocalUtil.isEnglish()) installationEnName
