...
class RvHomeFifthExtraSectionAdapter @Inject constructor() :
    ListAdapter<PropertyModel, RvHomeFifthExtraSectionAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
    private lateinit var listener: OnItemClickListenerFifthSection
    ...
    fun setListener(listener: OnItemClickListenerFifthSection, favClickListener: FavClickListener) {
        this.listener = listener
        this.favListener = favClickListener

    }

    interface OnItemClickListenerFifthSection {
        fun onItemClicked5(model: PropertyModel)
    }
