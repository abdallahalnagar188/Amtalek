...
import eramo.amtalek.databinding.ItemZoomSliderBinding
import eramo.amtalek.domain.model.dummy.AlbumModel
import javax.inject.Inject

class ZoomSliderAdapter @Inject constructor() :
    SliderViewAdapter<ZoomSliderAdapter.ImageSliderViewHolder>() {
    ...
    inner class ImageSliderViewHolder(private val binding: ItemZoomSliderBinding) :
...
//                listener.onBannerClick(getItemPosition(model))
//            }
        }
    }
