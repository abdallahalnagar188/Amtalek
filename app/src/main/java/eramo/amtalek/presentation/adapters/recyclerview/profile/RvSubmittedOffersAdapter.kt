...
import eramo.amtalek.databinding.ItemPropertyPreviewSubmittedOfferBinding
...
class RvSubmittedOffersAdapter @Inject constructor() :
    ListAdapter<PropertyModel, RvSubmittedOffersAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
    private lateinit var listener: OnItemClickListener
    private lateinit var favListener: FavClickListener


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ProductViewHolder(
        ItemPropertyPreviewSubmittedOfferBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    )
    ...
    inner class ProductViewHolder(private val binding: ItemPropertyPreviewSubmittedOfferBinding) :
        ...
        fun bind(model: PropertyModel) {
            ...
            binding.apply {
                ...
                tvMyOfferValue.text = " "+model.offerData?.offer
