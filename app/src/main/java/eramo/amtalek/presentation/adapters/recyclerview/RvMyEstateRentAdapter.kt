...
class RvMyEstateRentAdapter @Inject constructor() :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ProductViewHolder(
        ItemMyEstateRentBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    )
    ...
    inner class ProductViewHolder(private val binding: ItemMyEstateRentBinding) :
